...
const SwitchButtons = ({ left, right }) => {
  return (
    <>
      <div style={{ width: "100%", display: "flex" }}>
        <button style={{ widht: "50%" }} />
      </div>
    </>
  );
};

const InputComponent = ({ legend, text }) => {
  return (
...
const CustomerDetails = (props) => {
  return (
    <div className="container">
      <div className="row" style={{ background: "#e7e7e7" }}>
        <div
          className="col d-flex flex-column align-items-center py-3 px-5 m-4 rounded"
        ...
        >
          ...
          <h6 className="m-1">Author Noah</h6>
          ...
          <div className="my-3" style={{ width: "100%" }}>
            ...
            >
              ...
              <button style={{ width: "50%", border: "none" }}>Disabled</button>
            </div>
        ...
        <div
          className="col-8 d-flex flex-column align-items-start py-3 px-5 m-4 rounded"
          style={{ background: "white" }}
        >
